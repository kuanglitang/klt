...
<div class="panel panel-default">
    <div class="panel-heading">		
		<div class="form-group">
            <button class="btn btn-default ajax-get confirm" url="<?php echo U('clear');?>">清 空</button>
            <button class="btn btn-default ajax-post confirm" target-form="ids" url="<?php echo U('remove');?>">删 除</button>  
		</div>		
	</div><!-- /.panel-heading -->
