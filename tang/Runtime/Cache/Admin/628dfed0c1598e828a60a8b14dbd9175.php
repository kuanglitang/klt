  ...
  <div class="row">  
	...
	<div class="tab-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('updatepassword');?>">修改密码</a></li>
		</ul>
		<div class="tab-content">
			<!-- 修改密码表单 -->
			<form action="<?php echo U('User/submitPassword');?>" method="post" role="form" class="form col-lg-6" autocomplete="off">
