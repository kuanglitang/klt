  ...
  <div class="row">  
	...
	<div class="tab-wrap"> 
		<ul class="nav nav-tabs ">
			<li class="active"><a href="<?php echo U('updatenickname');?>">修改昵称</a></li>
			<li ><a href="<?php echo U('updatepassword');?>">修改密码</a></li>
		</ul>
		<div class="tab-content">
			<!-- 修改昵称表单 -->
			<form action="<?php echo U('User/submitNickname');?>" method="post" role="form" class="form col-lg-6" autocomplete="off">
				...
				<div class="form-group">
					...
					<input type="text" name="nickname" class="form-control" autocomplete="off" value="<?php echo get_username();?>"/>			 
				</div>
				<div class="form-group">
					<button type="submit" class="btn btn-default submit-btn ajax-post" target-form="form">确 认</button>
