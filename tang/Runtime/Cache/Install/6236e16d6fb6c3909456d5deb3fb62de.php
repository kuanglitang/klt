...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/Public/Install/css/bootstrap.css" rel="stylesheet">
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/index.php/Install/Install/step2.html" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="think_">
